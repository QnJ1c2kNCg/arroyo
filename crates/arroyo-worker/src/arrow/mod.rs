...
/// DataFusion replaces plan nodes when resetting; keep the returned root. Existing
/// streams retain their old nodes, so concurrently active windows stay isolated.
